          ...
          {suggestions.map((suggestion) => {
            ...
            return (
              <button
                ...
                className="group rounded-2xl border border-zinc-700 bg-zinc-900 px-4 py-3 text-left transition hover:border-violet-500 hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-zinc-950"
              >
                <span className="block text-[10px] font-semibold uppercase tracking-[0.15em] text-zinc-500 group-hover:text-violet-300">
                  {typeLabel}
                </span>

                <span className="mt-1 block text-sm font-medium text-zinc-200 group-hover:text-white">
                  {suggestion.label}
